...
export class AccountPage extends React.Component {
    constructor(props, context) {
        ...
        _defineProperty(this, "isEditEmailAllowed", features.isEditEmailAllowed)
        ...
        return /*#__PURE__*/React.createElement(ContentPage, {
            ...
            /*#__PURE__*/React.createElement(TextContent,
                ...
                /*#__PURE__*/React.createElement('span', {
                    style : {color: "red"}
                }, '* ', /*#__PURE__*/React.createElement('small', {style: {color: 'var(--pf-c-content--small--Color) !important',display: 'inline'}}, Msg.localize('allFieldsRequired')
                    )
                )
            ...
            !this.isRegistrationEmailAsUsername && fields.username != undefined && /*#__PURE__*/React.createElement(FormGroup, {
                ...
                this.isEditUserNameAllowed && /*#__PURE__*/React.createElement(this.UsernameInput, null),
                !this.isEditUserNameAllowed && /*#__PURE__*/React.createElement(this.RestrictedUsernameInput, null)
            ),
            !this.isUpdateEmailFeatureEnabled && /*#__PURE__*/React.createElement(FormGroup, {
                ...
                this.isEditEmailAllowed &&/*#__PURE__*/React.createElement(TextInput, {
                    isRequired: true,
                    type: "email",
                    id: "email-address",
                    name: "email",
            ...
            ,!this.isEditEmailAllowed && React.createElement(
                TextInput, {
                    isReadOnly: true,
                    type: "email",
                    id: "email-address",
            ...
            /*#__PURE__*/React.createElement(FormGroup, {
                  label: Msg.localize("adelink"),
                  fieldId: "ade-link",
                  helperTextInvalid: this.state.errors.adeLink,
                  validated: this.state.errors.adeLink !== "" ? ValidatedOptions.error : ValidatedOptions.default
                },
                /*#__PURE__*/React.createElement(TextInput, {
                  isRequired: false,
                  type: "text",
                  ...
                  name: "adeLink",
                  maxLength: 100,
                  value: fields.attributes["ade_link"] || "",
                  onChange: value => this.setState({
                    errors: this.state.errors,
                    formFields: {
                        ...this.state.formFields,
