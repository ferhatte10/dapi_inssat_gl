...
const {validateCompanyCreation,validateCompanyUpdate }= require('../validators/company.validator');

router.get('/', companyController.getAllCompanies);
router.get('/:id', verifyRequestParamId, companyController.getCompanyById);
router.get('/:id/users', verifyRequestParamId, companyController.getCompanyByIdUsers);
